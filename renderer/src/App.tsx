    ...
    {!emailsLoading && emails.map(email => (
      ...
      >
        ...
        <div className="flex justify-between items-start gap-2">
          ...
          {/* ✅ LEFT CONTENT (FIX: min-w-0 + flex-1) */}
          <div className="min-w-0 flex-1">
            <p className="font-medium truncate searchable-text">
              {email.subject}
            </p>

            <p className="text-xs text-pink-500 truncate searchable-text">
              {email.sender}
            </p>
          ...
          {/* ✅ RIGHT BADGE (FIX: flex-shrink-0) */}
          <span className="flex-shrink-0 text-xs px-2 py-0.5 rounded bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300">
            {email.category}
          </span>
